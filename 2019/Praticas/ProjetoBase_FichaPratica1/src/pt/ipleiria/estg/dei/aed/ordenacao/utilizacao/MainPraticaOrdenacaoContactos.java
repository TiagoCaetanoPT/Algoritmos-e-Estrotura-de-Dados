...
public class MainPraticaOrdenacaoContactos {
    ...
    public MainPraticaOrdenacaoContactos() {
        Contacto[] contactosOriginais = new Contacto[]{
                new Contacto("Ana","Silva",950000000,"Rua de Leiria", new Data(01,10,1990)),
                new Contacto("Ana","Rita",990000000,"Travessa 25 de Abril", new Data(15,06,2000)),
                new Contacto("Hugo","Santos",971234567,"Avenida 1º de Maio", new Data(18,03,1994)),
        ...
        AlgoritmoOrdenacao<Contacto> algoritmo1 = new InsertionSort<>(ComparacaoContactosPorNumeroTelefoneDescendente.CRITERIO);
        InsertionSort<Contacto> algoritmo2 = new InsertionSort<>(ComparacaoContactosPorUltimoNomeAscendenteSeguidoPorDataNascimentoDescendente.CRITERIO);
